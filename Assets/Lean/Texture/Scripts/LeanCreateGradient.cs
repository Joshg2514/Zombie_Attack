...
namespace Lean.Texture
{
	...
	public class LeanCreateGradient : LeanCreate
	{
		...
		{
			LeanEditor.Draw("size", "The size of the created texture.");
			LeanEditor.Draw("colorA", "The first color of the gradient.");
			LeanEditor.Draw("colorB", "The second color of the gradient.");

			LeanEditor.Separator();

			LeanEditor.Draw("coordinate", "The coordinate space of the points, where 0 is the bottom left.");
			LeanEditor.Draw("pointA", "The first point of the gradient.");
			LeanEditor.Draw("pointB", "The second point of the gradient.");
		}
#endif
	}
}