...
namespace Lean.Texture
{
	...
	public class LeanFilterGrayscale : LeanFilter
	{
		...
		{
			LeanEditor.Draw("strength", "The strength of the grayscale effect.\n\n0 = No change.\n\n1 = Fully grayscale.");
			LeanEditor.Draw("outputTo", "This allows you to specify the channels the grayscale value will be written to.");
		}
#endif
	}
}