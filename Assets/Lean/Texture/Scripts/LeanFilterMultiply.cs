...
namespace Lean.Texture
{
	...
	public class LeanFilterMultiply : LeanFilter
	{
		...
		{
			LeanEditor.Draw("channels", "How should the texture channels should be modified?");
			if (LeanEditor.GetProperty("channels").intValue == (int)ChannelType.Individual)
			{
				LeanEditor.Draw("multiplierR", "This channel value will be multiplied by this value.");
				LeanEditor.Draw("multiplierG", "This channel value will be multiplied by this value.");
				LeanEditor.Draw("multiplierB", "This channel value will be multiplied by this value.");
				LeanEditor.Draw("multiplierA", "This channel value will be multiplied by this value.");
			}
			else
			{
				LeanEditor.Draw("multiplier", "All channels will be multiplied by this value.");
			}
		}
#endif
	}
